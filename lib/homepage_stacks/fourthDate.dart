...
class Fourthdate extends ConsumerStatefulWidget {
  const Fourthdate({super.key});

  @override
  ConsumerState<Fourthdate> createState() => _FourthdateState();
}

class _FourthdateState extends ConsumerState<Fourthdate> {
  @override
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                '${ref.read(wordWeekdayToInt)[(DateTime.now().weekday + 2) % 7]} Lectures',
                style: TextStyle(
                  fontSize: 18,
        ...
        Flexible(
          ...
          child: ListView.builder(
            ...
            itemCount: ref.read(threeDaysLaterLectureSQLprovider).isEmpty
                ? 1
                : ref.read(threeDaysLaterLectureSQLprovider).length,
            itemBuilder: (context, index) {
              ...
              if (ref.read(threeDaysLaterLectureSQLprovider).isNotEmpty) {
                dataToUse = ref.read(threeDaysLaterLectureSQLprovider);

...
class Seventhdate extends ConsumerStatefulWidget {
  const Seventhdate({super.key});

  @override
  ConsumerState<Seventhdate> createState() => _SeventhdateState();
}

class _SeventhdateState extends ConsumerState<Seventhdate> {
  @override
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                '${ref.read(wordWeekdayToInt)[(DateTime.now().weekday + 5) % 7]} Lectures',
                style: TextStyle(
                  fontSize: 18,
        ...
        Flexible(
          ...
          child: ListView.builder(
            ...
            itemCount: ref.read(sixDaysLaterLectureSQLprovider).isEmpty
                ? 1
                : ref.read(sixDaysLaterLectureSQLprovider).length,
            itemBuilder: (context, index) {
              ...
              if (ref.read(sixDaysLaterLectureSQLprovider).isNotEmpty) {
                dataToUse = ref.read(sixDaysLaterLectureSQLprovider);

...
class Sixthdate extends ConsumerStatefulWidget {
  const Sixthdate({super.key});

  @override
  ConsumerState<Sixthdate> createState() => _SixthdateState();
}

class _SixthdateState extends ConsumerState<Sixthdate> {
  @override
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                '${ref.read(wordWeekdayToInt)[(DateTime.now().weekday + 4) % 7]} Lectures',
                style: TextStyle(
                  fontSize: 18,
        ...
        Flexible(
          ...
          child: ListView.builder(
            ...
            itemCount: ref.read(fiveDaysLaterLectureSQLprovider).isEmpty
                ? 1
                : ref.read(fiveDaysLaterLectureSQLprovider).length,
            itemBuilder: (context, index) {
              ...
              if (ref.read(fiveDaysLaterLectureSQLprovider).isNotEmpty) {
                dataToUse = ref.read(fiveDaysLaterLectureSQLprovider);

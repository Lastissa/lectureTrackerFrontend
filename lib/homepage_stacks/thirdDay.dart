...
class ThirdDay extends ConsumerStatefulWidget {
  const ThirdDay({super.key});

  @override
  ConsumerState<ThirdDay> createState() => ThirdDayState();
}

class ThirdDayState extends ConsumerState<ThirdDay> {
  @override
      ...
      children: [
        ...
        Flexible(
          ...
          child: ListView.builder(
            ...
            itemCount: ref.read(twoDaysLaterLectureSQLprovider).isEmpty
                ? 1
                : ref.read(twoDaysLaterLectureSQLprovider).length,
            itemBuilder: (context, index) {
              ...
              if (ref.read(twoDaysLaterLectureSQLprovider).isNotEmpty) {
                dataToUse = ref.read(twoDaysLaterLectureSQLprovider);

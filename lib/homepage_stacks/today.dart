      ...
      children: [
        Column(
          children: [
            ...
            Container(
              margin: EdgeInsets.only(bottom: 10, right: 40, left: 16),
              child:
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: ref.watch(lightMode)
                          ? Colors.blueAccent
                          : const Color.fromARGB(255, 44, 91, 172),
            ...
            """;
                    ...
                    child: Text(
                      ...
                      style: TextStyle(letterSpacing: -1, wordSpacing: -0.5),
                    ),
                  ).animate().shakeX(

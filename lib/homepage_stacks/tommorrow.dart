...
class Tommorrow extends ConsumerStatefulWidget {
  const Tommorrow({super.key});

  @override
  ConsumerState<Tommorrow> createState() => _TommorrowState();
}

class _TommorrowState extends ConsumerState<Tommorrow> {
  @override
      ...
      children: [
        ...
        Flexible(
          ...
          child: ListView.builder(
            ...
            itemCount: ref.read(tommorowLectureSQLprovider).isEmpty
                ? 1
                : ref.read(tommorowLectureSQLprovider).length,
            itemBuilder: (context, index) {
              ...
              if (ref.read(tommorowLectureSQLprovider).isNotEmpty) {
                dataToUse = ref.read(tommorowLectureSQLprovider);

                          ...
                          Expanded(
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                ...
                                ref.read(_allUserData.notifier).state =
                                    _formerData;
                                ref
                                        .read(_registeredCourseCount.notifier)
                                        .state =
                                ...
                                ref.read(_allTitles.notifier).state =
                                    _formerTitleData;
                                final _formerStartTimeData = ref.read(
                                  _start_time,
                                );
                                ...
                                final _formerAllIsClicked = ref.read(
                                  _allIsClicked,
                                );
                                                ...
                                                return Container(
                                                  ...
                                                  child: ElevatedButton(
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      List<bool> currentClicks =
                                                          ref.read(
                                                            _allIsClicked,
                                                          );
                                                      currentClicks.removeAt(
                                                        index,
                                                      );
